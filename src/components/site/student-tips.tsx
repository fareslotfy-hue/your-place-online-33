...
const tips = [
  {
    ...
    description:
      "مواد زي الهندسة الوصفية والفيزياء والكيمياء محتاجة تركيز عالي. خليها أول النهار لما يكون عقلك فريش. الصباح هو الوقت الذهبي للمواد الصعبة.",
    color: "text-red-400",
  ...
  },
  {
    ...
    description:
      "ذاكر 25 دقيقة بتركيز كامل، ثم خد راحة 5 دقائق. كل 4 جلسات خد راحة 15-20 دقيقة. ده بيخلي عقلك يستوعب أكتر بدون ما يجيلك إرهاق.",
  ...
  },
  {
    ...
    description:
      "الكيمياء وهندسة الإنتاج مواد متصلة على الترمين. ماتسيبش محاضراتها تتراكم. ذاكر كل أسبوع اللي خدته عشان ماتلاقيش نفسك قبل الفاينل محتاج تذاكر سنة كاملة.",
  ...
  },
  {
    ...
    description:
      "في مواد زي الفيزياء والهندسة الوصفية، الفهم هو الأساس. لو فهمت الفكرة الأساسية، هتقدر تحل أي مسألة. الحفظalone مش كافي وبيهرب بسرعة.",
  ...
  },
  {
    ...
    description:
      "المواد الهندسية مش بس مذاكرة نظرية. حل تمارين متنوعة من مصادر مختلفة. كل ما تحل أكثر، كل ما تكتشف أنماط جديدة وتزيد سرعتك في الامتحان.",
  ...
  },
  {
    ...
    description:
      "بعد كل محاضرة، راجعها في نفس اليوم. بعد أسبوع، راجعها تاني. قبل الامتحان هتلاقي إنك حافظها وفاهمها. المراجعة بتثبت المعلومة في الذاكرة طويلة المدى.",
    color: "text-blue-400",
...
const subjectPriority = [
  {
    ...
    advice:
      "دي أصعب مادة في الفرقة الإعدادية. ماتسيبش أي محاضرة بدون ما تفهمها كويس. ارسم كتير على ورق مسطر وتمرن على الإسقاطات. لو حسيت إنك ضعت، اسأل فوراً.",
    color: "text-red-400",
    icon: AlertTriangle,
  },
  {
    ...
    advice:
      "الفهم أهم من الحفظ. ركز على الميكانيكا والكهرباء. حل مسائل كتير وافهم القوانين بدل ما تحفظها. اعتبرها استثمار للمواد القادمة.",
    color: "text-amber-400",
    icon: TrendingUp,
  },
  {
    ...
    hoursPerWeek: "6-8 ساعات",
    advice:
      "مادة متصلة على الترمين، يبقى ماتسيبش حاجة تتراكم. ذاكر كل أسبوع. ركز على التفاعلات والمعادلات. اعمل ملخص خاص بيك للمفاهيم الأساسية.",
    color: "text-amber-400",
    icon: TrendingUp,
  },
  {
    ...
    advice:
      "مادة متصلة زي الكيمياء. افهم عمليات التصنيع والإنتاج. اربط بين المفاهيم النظرية والتطبيقات العملية. اعمل مخططات لكل عملية.",
    color: "text-amber-400",
    icon: TrendingUp,
  },
  {
    ...
    advice:
      "مادة عملية محتاجة تمرين مستمر. ارسم كتير. تعلم الأدوات والرموز الهندسية. التزم بالمعايير القياسية. الفاينل في الترم التاني فمتقطعش.",
    color: "text-blue-400",
    icon: BookOpen,
  },
  {
    ...
    advice:
      "خليك على ورد يومي ولو نصف صفحة. التكرار هو سر الحفظ. اربط الحفظ بالتلاوة في الصلوات. ده أحسن استثمار لوقتك وأعظم أجر.",
    color: "text-emerald-400",
    icon: Star,
  },
  {
    ...
    advice:
      "مواد سهلة بس متستهنش بيها. دي درجات مضمونة. ذاكرها في الأوقات اللي عقل بيكون فيها أقل تركيز. خد عليها فل مارك.",
    color: "text-emerald-400",
    icon: CheckCircle2,
  },
];
    ...
    <div className="space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground font-body text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
          نصائح عملية وخطة تعليمية من طالب حصل على تقدير امتياذ وكان الأول على الدفعة. اتبعها وستحقق
          تفوقاً بإذن الله.
        </p>
      </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground font-body leading-relaxed">
              ...
              ماتسيبش حاجة تتراكم، وحل تمارين كتير. وفايدك ربنا بقراءة القرآن والدعاء. التوفيق من
              ربنا قبل أي حاجة.&quot;
            </p>
          </div>
        </div>
      ...
      <div className="mt-10">
        <div className="text-center mb-6">
          <Badge
            variant="outline"
            className="mb-3 border-emerald-400/30 text-emerald-400 bg-emerald-400/5"
          >
        ...
        <div className="space-y-3">
          {subjectPriority.map((subject, i) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div
                  className={`w-10 h-10 rounded-xl bg-muted/50 flex items-center justify-center flex-shrink-0`}
                >
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between flex-wrap gap-2 mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge
                        variant="outline"
                        className={`text-xs ${subject.color.includes("red") ? "border-red-500/30 text-red-400" : subject.color.includes("amber") ? "border-amber-500/30 text-amber-400" : "border-emerald-500/30 text-emerald-400"}`}
                      >
                        {subject.priority}
                      </Badge>
      ...
      >
        ...
        <h3 className="font-display font-bold text-xl text-foreground mb-2">تذكر دائماً</h3>
        <p className="text-sm text-muted-foreground font-body leading-relaxed max-w-2xl mx-auto">
          التفوق مش هدف، دي رحلة. كل يوم بتتعلم فيه حاجة جديدة، أنت بتقرب من هدفك. &quot;وَقُل
          رَّبِّ زِدْنِي عِلْمًا&quot; - خليك متواضع، واسأل ربنا التوفيق، واعمل بجهد. النجاح هيجي
          بإذن الله. 💚
        </p>
      </motion.div>
    </div>
