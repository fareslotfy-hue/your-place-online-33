    ...
    <section id="fiqh-books" className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <Badge
            variant="outline"
            className="mb-4 border-emerald-400/30 text-emerald-300 bg-emerald-400/5"
          >
            مادة الفقه
          </Badge>
          ...
          <p className="text-muted-foreground font-body text-base md:text-lg leading-relaxed">
            سبع مراجع مرتّبة لمادة الفقه للفرقة الأولى هندسة الأزهر: تبدأ بالشرح الكامل، ثم المذكرة
            والملخّص، وتنهي ببنك الأسئلة والخرائط الذهنية وكارت المراجعة النهائية — كلها إعداد
            وتنسيق منصة الإمام الأكبر.
          </p>
        </motion.div>
