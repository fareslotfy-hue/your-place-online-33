    ...
    <div className="flex items-center gap-3 group cursor-pointer">
      ...
      >
        <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          ...
          <path d="M24 2 L42 12 L42 36 L24 46 L6 36 L6 12 Z" stroke="url(#logoGradient)" strokeWidth="2" fill="rgba(16, 185, 129, 0.05)" />
          <path d="M24 10 L30 18 L24 26 L18 18 Z M24 22 L30 30 L24 38 L18 30 Z" fill="url(#logoGold)" opacity="0.9" />
          <circle cx="24" cy="24" r="3" fill="#10B981" />
        </svg>
      </motion.div>
      <div className="flex flex-col">
        <span className={`font-display font-bold ${dimensions.text} text-gradient-gold leading-none`}>
          الإمام الأكبر
        </span>
