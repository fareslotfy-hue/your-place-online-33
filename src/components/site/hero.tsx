    ...
    >
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-body text-foreground/80">
              منصة تعليمية متكاملة للفرقة الإعدادية - كلية الهندسة
            </span>
          ...
          <motion.h1
            ...
            className="font-display font-black text-5xl md:text-7xl lg:text-8xl mb-6 text-gradient-gold text-shadow-glow leading-tight"
          >
            الإمام الأكبر
          </motion.h1>
          ...
          >
            ...
            <p className="font-body text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              ...
              دراسية مصممة خصيصاً لطلاب الفرقة الإعدادية بكلية الهندسة.
            </p>
          </motion.div>
          ...
          >
            <Button
              ...
              className="group bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white px-8 h-14 text-base shadow-glow"
            >
            ...
            <Button
              ...
              className="glass border-amber-400/30 text-foreground hover:bg-amber-400/10 px-8 h-14 text-base"
            >
      ...
      >
        <motion.div
          ...
          className="w-6 h-10 rounded-full border-2 border-amber-400/50 flex items-start justify-center p-2"
        >
