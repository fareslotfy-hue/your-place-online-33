...
const values = [
  {
    ...
    title: "رسالتنا",
    description:
      "تقديم تعليم هندسي عالي الجودة يجمع بين الأصالة العلمية والابتكار التقني، وإعداد طلاب متميزين قادرين على مواكبة التطورات العلمية الحديثة في مجالات الهندسة المختلفة.",
  ...
  },
  {
    ...
    title: "رؤيتنا",
    description:
      "أن نكون المنصة التعليمية الرائدة في المنطقة العربية للتعليم الهندسي، ومرجعاً موثوقاً لطلاب الفرقة الإعدادية بكلية الهندسة.",
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground font-body text-base md:text-lg leading-relaxed mb-6">
              منصة "الإمام الأكبر" التعليمية هي منصة متخصصة في تقديم المحتوى التعليمي لطلاب الفرقة
              الإعدادية بكلية الهندسة، تهدف إلى تطوير تجربة التعلم من خلال دمج التراث العلمي العريق
              مع أحدث الأساليب التعليمية والتقنيات الرقمية الحديثة.
            </p>
            <p className="text-muted-foreground font-body text-base md:text-lg leading-relaxed mb-8">
              نؤمن بأن التعليم الهندسي يجب أن يكون متاحاً للجميع، وأن يجمع بين الأصالة والمعاصرة،
              لذا نوفر محتوى تعليمياً شاملاً ومتنوعاً يلبي احتياجات الطلاب في عصر التحول الرقمي
              ويساعدهم على التفوق والتميز الأكاديمي.
            </p>
