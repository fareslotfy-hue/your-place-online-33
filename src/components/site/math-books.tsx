      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground font-body text-base md:text-lg leading-relaxed">
            خمس مراجع مرتّبة لمادة الرياضة الهندسية للفرقة الإعدادية: تبدأ بالكتاب الأساسي وشروحات
            الدكاترة، ثم التدريبات والمسائل، وتنتهي ببنك الامتحانات ومذكرة الشيتات — كلها إعداد
